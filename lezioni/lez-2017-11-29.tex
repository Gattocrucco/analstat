...
\marginpar{Magari aggiungere una sottosezione conclusiva
in cui osserviamo che i criteri con cui abbiamo deciso
all'inizio di preferire una stima intervallare a una puntuale,
si possono riassumere sinteticamente nel fatto che una stima
puntuale è utile se si riesce a ricavarne una stima intervallare.}
