...
\begin{definition}[Probabilità]
	\marginpar{La probabilità è definita su una $\sigma$-algebra.
	Si può vedere in ogni caso come un insieme delle parti?\\
	\emph{No, controesempio: la $\sigma$-algebra generata dagli aperti di $\R$
	...
	\begin{enumerate}
		...
		\marginpar{L'assioma \ref{kolm2} va posto anche per le unioni numerabili?}
		\item $P(S)=1$.
	\end{enumerate}
\end{definition}
