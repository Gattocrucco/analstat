...
\begin{defn}[Densità di probabilità]
...
\begin{es}
	...
	\begin{equation*}
		...
		\frac{p(x)}{2x} + \frac{p(x)}{2x} = \frac{p(x)}{x}.
	\end{equation*}
\end{es}
...
\begin{defn}[Convergenza in probabilità]
...
\begin{fat}[Leggi dei grandi numeri]
